...
class Money private constructor(
     ...
     * @sample com.abroadbent.money.MoneyArithmeticTest.PlusOperatorTest
     */
     ...
     * @throws IllegalArgumentException if the given Money object has a different currency
     * @sample com.abroadbent.money.MoneyArithmeticTest.MinusOperatorTest
     */
     ...
     * @sample com.abroadbent.money.MoneyArithmeticTest.TimesOperatorTest
     */
     ...
     * @sample com.abroadbent.money.MoneyArithmeticTest.DivideOperatorTest
     */
    operator fun div(factor: Int) =
        Money(amount = amount.toDouble().div(factor).roundToLong(), currency = currency)
     ...
     * @sample com.abroadbent.money.MoneyComparableTest
     */
     ...
     * @sample com.abroadbent.money.MoneyExtraFunctionsTest.PercentageTest
     */
     ...
     *
     * @sample com.abroadbent.money.MoneyExtraFunctionsTest.IsPositiveTest
     */
     ...
     *
     * @sample com.abroadbent.money.MoneyExtraFunctionsTest.IsNegativeTest
     */
     ...
     * @sample com.abroadbent.money.MoneyToStringTest
     */
    ...
    companion object {
         ...
         * @sample com.abroadbent.money.MoneyUtilTest.MinTest
         */
         ...
         * to avoid any misleading result.
         *
         * @sample com.abroadbent.money.MoneyUtilTest.MaxTest
         */
